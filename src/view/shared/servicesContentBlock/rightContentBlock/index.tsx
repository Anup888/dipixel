...
type RightContentBlockProps = {};
type RightContentBlockState = {};

class RightContentBlock extends Component<
  RightContentBlockProps,
  RightContentBlockState
> {
  constructor(props: RightContentBlockProps) {
    super(props);
    this.state = {};
  }
  render() {
